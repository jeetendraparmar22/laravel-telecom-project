            ...
            <ul class="navbar-nav mr-auto">
                <li class="nav-item dropdown">
                    ...
                    <div class="form-group">
                        <select class="form-control" id="formno" name="formno" onchange = "getFormDetails()">
                            <option>Select Invoice No</option>
                            @foreach ($allocate_forms as $form)
                            <option value="{{ $form->invoice_no }}">{{ $form->invoice_no }}</option>
